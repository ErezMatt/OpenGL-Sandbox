...
AmbientLightScene::AmbientLightScene(std::shared_ptr<SceneData> data)
    :_data(data)
{
    init();
}

void AmbientLightScene::init()
{
    ...
    light = Light(1.0f, 1.0f, 1.0f, 1.0f, 0.0f);
...
void AmbientLightScene::update(float dT)
{
    if (rotation >= 360)
        rotation -= 360;
    ++rotation;
...
void AmbientLightScene::imGuiRender()
{
